    ...
    <div className=''>
      {data.map((item, index) => (
        <div className='xui-mt-1-half xui-cursor-pointer' key={index} onClick={() => toggleItem(index)}>
          <div className={'xui-d-flex xui-flex-ai-center xui-mt-2 iyd-bg-blue xui-py-1-half xui-px-1 xui-pos-relative ' + (activeIndex === index ? 'iyd-bg-purple' : 'xui-bg-none')}>
          ...
          {activeIndex === index &&
           <div className='xui-lg-p-2 xui-p-1 iyd-bg-purple xui-pos-relative'>
